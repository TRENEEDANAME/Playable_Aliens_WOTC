...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(PA_CCSBomber());
...
static function X2AbilityTemplate PA_CCSBomber()
{
	local X2AbilityTemplate Template;
	local X2AbilityToHitCalc_StandardAim ToHit;
	...
	// Create the template using a helper function
	Template = Attack('PA_CCSBomber', "img:///KetarosPkg_Abilities.UIPerk_shootingtarget", false, none, class'UIUtilities_Tactical'.const.CLASS_SERGEANT_PRIORITY, eCost_None);
