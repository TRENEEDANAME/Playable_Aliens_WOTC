class OPTC_RushAndBind extends X2DownloadableContentInfo config(Game);

var config name RushAndBindAbility;
...
static event OnPostTemplatesCreated()
{
    ...
    Template = AbilityTemplateManager.FindAbilityTemplate(default.RushAndBindAbility);
